...
import math
tour = [0]
# append the minimum weight node from the row attached to the last node in tour, where weight (lamda k) is the weight between cities if the city is not in the tour, and infinite (math.inf) if it is.
